...
const SCHEMA_COLUMNS = {
  ...
  clientes: ['cli_id', 'cli_com_id', 'cli_dni_cif', 'cli_nombre_razon_social', 'cli_nombre_cial', 'cli_numero_farmacia', 'cli_direccion', 'cli_poblacion', 'cli_codigo_postal', 'cli_movil', 'cli_email', 'cli_tipo_cliente_txt', 'cli_tipc_id', 'cli_CodPais', 'cli_Pais', 'cli_Idioma', 'cli_idiom_id', 'cli_Moneda', 'cli_mon_id', 'cli_NomContacto', 'cli_tarifa_legacy', 'cli_formp_id', 'cli_dto', 'cli_CuentaContable', 'cli_RE', 'cli_Banco', 'cli_Swift', 'cli_IBAN', 'cli_Modelo_347', 'cli_prov_id', 'cli_codp_id', 'cli_telefono', 'cli_Web', 'cli_pais_id', 'cli_ok_ko', 'cli_estcli_id', 'cli_activo', 'cli_FechaBaja', 'cli_MotivoBaja', 'cli_tipo_contacto', 'cli_Id_cliente_relacionado'],
