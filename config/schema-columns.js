...
const SCHEMA_COLUMNS = {
  ...
  pedidos: ['ped_id', 'ped_com_id', 'ped_cli_id', 'ped_direnv_id', 'ped_formp_id', 'ped_tipp_id', 'ped_tarcli_id', 'ped_estped_id', 'ped_numero', 'ped_fecha', 'ped_total', 'ped_base', 'ped_iva', 'ped_estado_txt'],
