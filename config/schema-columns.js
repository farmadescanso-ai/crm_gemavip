...
const SCHEMA_COLUMNS = {
  ...
  clientes: ['cli_id', 'cli_com_id', 'cli_dni_cif', 'cli_nombre_razon_social', 'cli_nombre_cial', 'cli_numero_farmacia', 'cli_direccion', 'cli_poblacion', 'cli_codigo_postal', 'cli_movil', 'cli_email', 'cli_tipo_cliente_txt', 'cli_tipc_id', 'cli_esp_id', 'cli_CodPais', 'cli_Pais', 'cli_Idioma', 'cli_idiom_id', 'cli_Moneda', 'cli_mon_id', 'cli_NomContacto', 'cli_tarifa_legacy', 'cli_formp_id', 'cli_dto', 'cli_CuentaContable', 'cli_RE', 'cli_Banco', 'cli_Swift', 'cli_IBAN', 'cli_Modelo_347', 'cli_prov_id', 'cli_codp_id', 'cli_telefono', 'cli_Web', 'cli_pais_id', 'cli_ok_ko', 'cli_estcli_id', 'cli_activo', 'cli_FechaBaja', 'cli_MotivoBaja', 'cli_tipo_contacto', 'cli_Id_cliente_relacionado'],
  ...
  clientes_cooperativas: ['id', 'Id_Cliente', 'Id_Cooperativa', 'NumAsociado'],
  codigos_postales: ['codpos_id', 'codpos_CodigoPostal', 'codpos_Localidad', 'codpos_Provincia', 'codpos_Id_Provincia', 'codpos_ComunidadAutonoma', 'codpos_Latitud', 'codpos_Longitud', 'codpos_Activo', 'codpos_CreadoEn', 'codpos_ActualizadoEn', 'codpos_NumClientes'],
  ...
  pedidos: ['ped_id', 'ped_com_id', 'ped_cli_id', 'ped_direnv_id', 'ped_formp_id', 'ped_tipp_id', 'ped_tarcli_id', 'ped_Serie', 'ped_numero', 'ped_fecha', 'ped_FechaEntrega', 'ped_estado_txt', 'ped_estped_id', 'ped_Id_EstadoPedido', 'ped_total', 'ped_base', 'ped_iva'],
  pedidos_articulos: ['pedart_id', 'pedart_ped_id', 'pedart_art_id', 'pedart_numero', 'pedart_cantidad', 'pedart_pvp'],
