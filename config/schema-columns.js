...
const SCHEMA_COLUMNS = {
  ...
  articulos: ['art_id', 'art_sku', 'art_codigo_interno', 'art_nombre', 'art_presentacion', 'art_unidades_caja', 'art_largo_unidad', 'art_ancho_unidad', 'art_alto_unidad', 'art_kg_unidad', 'art_largo_caja', 'art_alto_caja', 'art_ancho_caja', 'art_peso_kg_Caja', 'art_cajas_palet', 'art_pvl', 'art_iva', 'art_imagen', 'art_mar_id', 'art_ean13', 'art_id_holded', 'art_holded_sync_at', 'art_activo'],
  ...
  comerciales: ['com_id', 'com_nombre', 'com_email', 'com_dni', 'com_password', 'com_roll', 'com_activo', 'com_fijo_mensual', 'com_movil', 'com_direccion', 'com_codp_id', 'com_poblacion', 'com_codigo_postal', 'com_prov_id', 'com_teams_access_token', 'com_teams_refresh_token', 'com_teams_email', 'com_teams_token_expires_at', 'com_meet_access_token', 'com_meet_refresh_token', 'com_meet_email', 'com_meet_token_expires_at', 'com_plataforma_reunion_preferida'],
