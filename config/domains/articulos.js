  ...
  async updateArticulo(id, payload) {
    try {
      ...
      const colMap = {
        ...
        Ancho_Unidad: pick(['art_ancho_unidad', 'Ancho_Unidad', 'ancho_unidad']),
        Alto_Unidad: pick(['art_alto_unidad', 'Alto_Unidad', 'alto_unidad']),
        Kg_Unidad: pick(['art_kg_unidad', 'Kg_Unidad', 'kg_unidad']),
        ...
        PesoKg_Caja: pick(['art_PesoKg_Caja', 'art_peso_kg', 'PesoKg_Caja', 'PesoKg', 'peso_kg']),
        Cajas_Palet: pick(['art_Cajas_Palet', 'art_cajas_palet', 'Cajas_Palet', 'cajas_palet']),
