...
El botón **Excel** en la ficha de un pedido:
- Si el pedido es **Transfer Hefame**: genera el Excel usando la plantilla Hefame (igual que el botón HEFAME).
- En caso contrario: genera un libro desde cero (sin plantilla), válido para imprimir cualquier pedido.
...
| **C12** | Cooperativa (nombre del mayorista, ej. HEFAME) |
| **C13** | Nombre (cliente) |
| **C14** | Código Hefame / Nº asociado (del pedido o de las cooperativas del cliente) |
| **C15** | Teléfono |
