 ...
 * @param {string} to
 * @param {{ notifId: number, cliId: number, clienteNombre?: string, diffCampos?: string[], sugerencia?: string|null }} data
 */
  ...
  const sugTxt =
    sug === 'crm_to_holded'
      ...
      : sug === 'holded_to_crm'
        ...
        : 'Hay divergencia: elija la dirección de sincronización.';
