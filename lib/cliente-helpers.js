...
function buildClienteFormModel({ mode, meta, item, comerciales, tarifas, provincias, paises, formasPago, tiposClientes, especialidades, idiomas, monedas, estadosCliente, cooperativas, gruposCompras, canChangeComercial, missingFields }) {
  ...
  byId.get('contacto').fields = promote(byId.get('contacto').fields, ['Email', 'Telefono', 'Movil', 'Web', 'cli_email', 'cli_telefono', 'cli_movil', 'cli_NomContacto', 'cli_nom_contacto', 'NomContacto', 'Nombre_Contacto', 'nom_contacto']);
  ...
  byId.get('datos_banco').fields = promote(byId.get('datos_banco').fields, ['cli_banco', 'cli_iban', 'cli_swift', 'Banco', 'IBAN', 'SWIFT', 'SWIFT_BIC', 'Cli_Banco', 'Cli_Iban', 'Cli_Swift']);
