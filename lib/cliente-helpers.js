...
function buildClienteFormModel({ mode, meta, item, comerciales, tarifas, provincias, paises, formasPago, tiposClientes, especialidades, idiomas, monedas, estadosCliente, cooperativas, gruposCompras, canChangeComercial, missingFields }) {
  ...
  const identPromote = ['Nombre_Razon_Social', 'Nombre_Cial', 'cli_nombre_razon_social', 'cli_nombre_cial', 'Id_TipoCliente', 'cli_tipc_id', 'cli_esp_id', 'TipoContacto', 'cli_tipo_contacto', 'Id_EstdoCliente', 'cli_estcli_id', 'DNI_CIF', 'cli_dni_cif', 'OK_KO', 'cli_ok_ko'];
