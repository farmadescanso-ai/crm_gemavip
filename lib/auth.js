...
/** Email del administrador del sistema (acceso exclusivo a vistas como Importar Holded). */
const SYSTEM_ADMIN_EMAIL = 'pedidos@farmadescanso.com';

function isSystemAdminUser(user) {
  const email = String(user?.email || '').trim().toLowerCase();
  return email === SYSTEM_ADMIN_EMAIL.toLowerCase();
}

/**
 * Middleware: solo permite acceso al usuario administrador del sistema (pedidos@farmadescanso.com).
